	...
	$("#messagesDropdown").click(function() {
		...
		$.get(url, function(rData) {
			...
			$.each(rData, function() {
				...
				cloneItem.find(".text-gray-500").text(this.msg_sender + " " + changeDateString(this.msg_senddate));
				// 아이디가 여러개 존재하니까 지워줌
							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown no-arrow mx-1"><a
									...
									<div
										...
										<h6 class="dropdown-header">읽지 않은 쪽지</h6>
										<a class="dropdown-item d-flex align-items-center" href="#" style="display:none" id="msgItem">
											...
											href="/message/message_receive_list">받은 쪽지 목록</a>
									</div></li>
								...
								<li class="nav-item dropdown no-arrow"><a
									...
									aria-expanded="false"> <span
										...
										- [${sessionScope.loginVo.user_point}]포인트
										</span> 
